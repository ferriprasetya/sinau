    ...
    <Card key={key} className='relative mb-6 px-5 py-4'>
      ...
      <CardHeader className='flex-col items-start px-4 pb-0 pt-2'>
        ...
        <div className='flex flex-wrap'>
          ...
          {/* <CardCategory category='Programming' />
          <CardCategory category='Coding' />
          <CardCategory category='Gabut' />
          <CardCategory category='Ngeteh' /> */}
        </div>
      ...
      <CardBody className='overflow-hidden py-2 md:flex'>
        <div className='flex flex-col md:flex-row'>
          <div className='h-64 overflow-hidden md:h-24'>
            <img
              alt='Card background'
          ...
          <div className='mt-3 md:ml-4 md:mt-0 md:w-[80%]'>
